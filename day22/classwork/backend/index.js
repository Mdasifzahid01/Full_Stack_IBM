...
app.post('/login',(req,res)=>{
    ...
    if(req.body.email == "mdasifzahid1422@gmail.com" && re.body.password == "123456"){
        res.status(200).send("massage':'User authentication successfully");
    }else{
        res.status(400).send("massage':'User authentication failed");
    }
});
